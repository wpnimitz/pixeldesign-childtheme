...
function show_rental_marker() {
	...
	$ret = '<h3>'.get_the_title().' Location</h3>';

	$ret .= '<div class="rental_mapper">';

		$ret .= '<img src="'. get_stylesheet_directory_uri() .'/assets/img/MasterPlanCommunityMap_ForWebsiteV2-1.jpg" width="100%" class="pin" easypin-id="rental_map">';
